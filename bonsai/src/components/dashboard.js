    ...
    <section className="">
      <div className="App">
          ...
          <div className="mainbox">
            <div className="left">
              <div className="dribbble">
                ...
                <img src="/assets/dribbble.JPG" alt="" height="35px" />
              </div>
              <h1>The business software for design agencies</h1>
              <p>
                Bonsai takes the stress out of running your agency. Run
                projects, win clients, get paid, and track your revenue. Start a
                free trial via the link below to get a 30% discount.
              </p>
        ...
        <div className="second">
          ...
          <img
            src="https://cdn.prod.website-files.com/637e5892fb4b6db88a62cc0a/66aa4b98cc4eba312364ad9f_Bonsai%20for%20Design%20agencies-p-1600.png"
            alt=""
            width="1060"
          />
        </div>
        ...
        <div className="third">
          ...
          <div className="invoices">
            ...
            <div className="col">
              <h1>Invoices</h1>
              <p>
                Get paid faster with integrated billing and online payments.
              </p>
            </div>
          </div>
          ...
          <div className="willian">
            ...
            <div className="willtext">
              <p>
                ...
                simplicity and data-driven insights continues to be invaluable
